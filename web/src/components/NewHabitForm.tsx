...
export function NewHabitForm(){
  ...
  return  (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6 ">
      <label htmlFor="title" className="font-semibold leagin-tight">
      ...
      <label htmlFor="title" className="font-semibold leagin-tight mt-4">
        Qual a recorrência?
      </label>

      <div className="flex flex-col gap-2 mt-3">
        {availbleWeekDays.map((weekDay,index)=>{
          return (
            <Checkbox.Root 
              key={weekDay}
