     ...
     <Dialog.Root>
      <Dialog.Trigger
        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Close className="absolute top-5 right-6 text-zinc-400 rounded-lg hover:text-zinc-200  focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900">
